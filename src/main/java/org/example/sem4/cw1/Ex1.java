...
public class Ex1 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Введите строку в формате текст~цифра/print~цифра, где цифра - позиция.");
            ...
            if (!("print".equals(inputStr[0]))) {
                if (ll.size() >= num) {
                    ...
                    System.out.println("Данной позиции не существует, элемент добавлен в конец");
                    ll.add(inputStr[0]);
                }
            } else {
                if (ll.size() >= num) {
