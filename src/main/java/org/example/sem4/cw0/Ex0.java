...
public class Ex0 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Элементы добавлены в ArrayList и выведены в консоль за " + timeElapsedArray + " миллисекунд(ы)");
        ...
        System.out.println("Элементы добавлены в LinkedList и выведены в консоль за " + timeElapsedList + " миллисекунд(ы)");
    }
